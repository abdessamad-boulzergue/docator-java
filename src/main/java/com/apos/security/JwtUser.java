...
public class JwtUser implements  UserDetails {
  ...
  public JwtUser(String sessionId, List<GrantedAuthority> authorities, JSONObject userJSONData) {
    ...
    //this.group = group;
    this.username = JsonUtil.getFielValue(userJSONData, "id");
    this.password =  JsonUtil.getFielValue(userJSONData, "pwd");
    this.lastName = JsonUtil.getFielValue(userJSONData, "nom");
    this.firstName = JsonUtil.getFielValue(userJSONData, "prenom");
    this.email = JsonUtil.getFielValue(userJSONData, "courriel");
    this.created = JsonUtil.getDateFromString(JsonUtil.getFielValue(userJSONData, "creationDate"));
    //this.rights = getUserRights(userJSONData);
    this.validityStartDate = JsonUtil.getDateFromString(JsonUtil.getFielValue(userJSONData, "debut_validite_utilisateur"));
    this.validityEndDate = JsonUtil.getDateFromString(JsonUtil.getFielValue(userJSONData, "fin_validite_utilisateur"));
    Date lastPwdResetDateTmp = JsonUtil.getDateFromString(JsonUtil.getFielValue(userJSONData, "date_chgt_mot_pas"));
